...
<div class="col-12">
      ...
      @endif        
<form action="{{route('update_transaksi')}}" id="form_user" method="POST" class="col-md-12">       
  <div class="row">
  {{ csrf_field() }}
  {{ method_field('PATCH') }}
            ...
            <div class="container-fluid">                
              <div class="form-row">                
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" id="no_pesanan" name="no_pesanan" value="{{$pesanan->no_pesanan}}" class="form-control" id="nama" placeholder="No Pesanan" readonly>                    
                </div>
                <div class="col-md-12 mb-3">
            ...
            <div class="container-fluid">                
              <div class="form-row">                
                <div class="col-8 mb-3">
                  ...
                  <input type="text" name="jumlah_pembayaran" value="{{$pesanan->total_harga}}" class="form-control" id="jumlah_bayar" placeholder="Jumlah Bayar" readonly>                    
                </div>
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input id="status_pembayaran" name="status_pembayaran" type="text" value="{{$pembayaran->status_pembayaran == "LUNAS" ? "LUNAS" : "BELUM LUNAS / CICILAN"}}" class="form-control" readonly>
                </div>   
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" name="total_bayar" value="{{$pembayaran->jumlah_pembayaran}}" class="form-control without-arrow" oninput="bayar(this)" required>                         
                </div>                                       
                <div class="col-md-6 mb-3">
        ...
        <table class="table table-fixed display nowrap"  id="data_table" width="100%">
          ...
          <tbody class="search-table" id="fill_barang_table">                      
              @foreach ($detailPesanan as $item)              
               ...
               <td>
                 <div class="input-group input-group-sm mb-3"><input type="text" value="{{$item->total_harga}}" name="total_harga[]" id="total_harga{{$item->barang_id}}" class="form-control total-harga" readonly required></div></td>
               <td>
