...
@endsection
@section('content')      
<form action="{{route('update_barang')}}" id="form_barang" method="POST" class="col-sm-12">           
  {{ csrf_field() }}
  {{ method_field('PATCH') }}
            ...
            <div class="container-fluid">
              <h5 class="card-title mb-4">
                ...
                <div class="form-group row">                          
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" id="nama" value="{{$barang->nama}}" placeholder="Nama Barang" required>                    
                  </div>                  
                </div>                      
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="stok">Kode BPOM</label> 
                    <div class="col-sm-10">
                      <input type="number" name="kode_bpom" value="{{$barang->kode_bpom}}" class="form-control" placeholder="Masukkkan Kode BPOM" required>
                    </div>
                  </div> 
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="input-group col-sm-2">
                        <input type="number" name="discount" value="{{$barang->discount * 100}}" class="form-control" id="discount" placeholder="Discount" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4" id="satuan_box">                         
                        <select class="custom-select" name="satuan_id" size="3" id="select_satuan" required>                          
                            @foreach ($barang->satuan->all() as $item)
