      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
          <div class="d-flex row">            
            <div class="p-2">
              <a href="{{route('create_toko')}}" class="btn btn-custom-success"><span class="fa fa-plus"></span> Tambah Barang</a>                                           
            </div>            
            <div class="p-2">
        ...
        <table class="table">
          ...
          <tbody class="search-table">
            ...
            <tr>                                         
                ...
                <td>{{$item->nama}}</td>                
                <td>{{$item->stok}}</td>                
                <td>Harga Jual : {{$item->harga_jual}}  <br>
                    harga Pabrik :  {{$item->harga_pabrik}} <br>
                    Discount :  {{$item->discount}}</td>                                                         
                <td>                  
