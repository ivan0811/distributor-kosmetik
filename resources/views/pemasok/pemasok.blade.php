      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
          <div class="d-flex row">            
            <div class="p-2">
              <a href="{{route('create_pemasok')}}" class="btn btn-custom-success"><span class="fa fa-plus"></span> Tambah Pemasok</a>                                           
            </div>            
            <div class="p-2">
            ...
            <div class="align-self-center p-2">
              <p class="text-card" style="margin-bottom: 0">Total Pemasok : <span class="total-row"></span></p>              
            </div>
